...
export const metadata:Metadata={
  ...
  openGraph:{title:"M. Arsalan | Author And Editorial Reviewer",description:authorConfig.description,url:authorConfig.url,type:"profile",images:[{url:authorConfig.image,width:512,height:512,alt:"Orange abstract portrait for M. Arsalan"}]},
};
...
export default function AuthorPage(){
  ...
  return <>
    ...
    <PageShell title={authorConfig.name} description="Author and editorial reviewer for the BIBIBOP Nutrition Calculator.">
      <section className="author-profile-intro"><Image className="author-profile-avatar" src={authorConfig.image} width="180" height="180" alt="Orange abstract portrait for M. Arsalan"/><div><h2>Professional Biography</h2><p>M. Arsalan works on the research, data organization, calculator development, and editorial review behind this independent nutrition website. The role centers on turning publicly available restaurant nutrition information into clear, testable, and useful calculator outputs.</p><p>The work includes checking portions and nutrient fields, preserving source notation, documenting uncertainty, and reviewing explanations so official values and site interpretation remain distinct. No medical credentials, licenses, degrees, certifications, employers, or years of experience are claimed.</p></div></section>
