...
export default function BlogPage(){const latest=[...blogPosts].sort((a,b)=>b.publishedDate.localeCompare(a.publishedDate));const breadcrumb={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:siteConfig.url},{"@type":"ListItem",position:2,name:"Blog",item:pageUrl}]};return <>
  ...
  <section className="blog-calculator-cta"><h2>Build And Compare Your BIBIBOP Order</h2><p>Use the live calculator to combine ingredients and review calories, protein, carbohydrates, fat, sodium, and published allergen flags.</p><Link className="button" href="/#calculator">Open the BIBIBOP calculator</Link></section>
  </div></div>
  </>}
